	      ...
	      <div class="st-content">
	        <div class="st-content-inner">
				...
				<div class="container">
                    ...
                    <div class="tab">
				        <button class="tablinks" onclick="openCity(event, 'quality-control')" id="defaultOpen">Quality Control (QC)</button>
				        <button class="tablinks" onclick="openCity(event, 'mdvr-software')">MDVR Software</button>
				        <button class="tablinks" onclick="openCity(event, 'mdvr-hardware')">MDVR Hardware</button>
				        <button class="tablinks" onclick="openCity(event, 'client-details')">Client Details</button>
    				</div>

				    <div id="quality-control" class="tabcontent">
				        <p><h4>Quality Control (QC)</h4></p>
...
<hr>				        <p><div class="row">
         ...
         <input type="submit" name="submit" class="btn btn-success" value = "Save to Database" style="margin-bottom: 40px;">
				    ...
				    <div id="mdvr-software" class="tabcontent">
				        <h3>MDVR Software</h3>
				        <p>MDVR Software stuff will apppear here...</p>
				    </div>

				    <div id="mdvr-hardware" class="tabcontent">
				        <h3>MDVR Hardware</h3>
				        <p>MDVR Hardware stuff will apppear here...</p>
				    </div>

				    <div id="mdvr-hardware" class="tabcontent">
				        <h3>Client Details</h3>
				        <p>Client Details stuff will appear here</p>
				    </div>
