...
for (i = 0; i < close.length; i++) {
    ...
    <script type="text/javascript">
        ...
        {
        window.location.href='suspended-accounts-records.php?delete_id='+id;
        }
    }
    </script>
...
include('include/connection.php');
    ...
    $sql = "SELECT * FROM suspended_accounts ORDER BY `client_name` DESC";
    $result = mysqli_query($conn, $sql);

    if(isset($_GET['delete_id']))
    {
        $sql="DELETE FROM suspended_accounts WHERE id =".$_GET['delete_id'];
        mysqli_query($conn, $sql);
        header("Location: suspended-accounts-records.php");
    }
    ...
    if (mysqli_num_rows($result)>0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            $i++;
                ...
                echo "<td><a href='javascript:delete_id(<?php echo $row[0]; ?>)'><img src='b_drop.png' alt='Delete' /></a></td>";
