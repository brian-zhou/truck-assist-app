...
/*START OF PHP E-MAIL 1*/
        ...
        $to = "$employee_email, $line_manager_email, debi@truckassist.co.za";
...
/*START OF PHP E-MAIL 2*/
        ...
        //$to = "$line_manager_email, $employee_email, v8alexander@gmail.com, caroline@truckassist.co.za, debi@truckassist.co.za";
        $to = "adrian@truckassist.co.za, caroline@truckassist.co.za, petrojohnson@one.za.com";
        $subject = "New leave application form submitted by $logged_by";
...
<div class="col-sm-12" style="">
	<legend><h5>Your form has been successfully submitted to your line manager: <span style="color:red"><?php echo $line_manager_email; ?></span> and a copy e-mailed to you at: <span style="color:red"><?php echo $employee_email; ?></span></h5>
</legend>
	</div>
</div>
 <div class="row">    	
