                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <h4>
                                        ...
                                        <a href="csv-mysql-leave-application.php"><button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-export"></span> Export CSV</button></a>
...
include('include/connection.php');
    ...
    if (mysqli_num_rows($result)>0){
       ...
       // echo "<th>Was Leave Approved By HR</th>";
        ...
        echo "<th>Motivation by Employee (If Any)</th>";
        echo "<th>Status of Request</th>";
        echo "<th>HR Comments (If Any)</th>";
